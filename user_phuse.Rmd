---
title: "Your PHUSE Connect Presenter History"
...
Your first connect was PHUSE `r first$region` `r first$year`, you presented for `r first$company` in the `r first$category` stream with _"`r first$title`"_.
